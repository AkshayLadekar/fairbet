        ...
        <div className="mb-static-content__rightside">
          ...
          <div className="mb-static-content__content">
            <div className="content">
              ...
              <p>
                fairbets.co values its players and is proud to be chosen as
              ...
              <p>
                fairbets.co recognizes that for a small portion of players
                wagering may lead to negative consequences in other areas of
                their life. fairbets.co encourages responsible gaming for its
                players and employees. For the players, fairbets.co achieves
                this by offering limit-setting and cool-off capabilities, making
                problem gambling resources available in all sports books and
                online gaming, and helping with self-exclusion both inhouse and
                in local jurisdictions. For employees, fairbets.co offers annual
                mandatory training for the ticket writers, customer service
              ...
              <p>
                ...
                signs, fairbets.co encourages you to measure your gambling risk
                level by taking a gambling risk test through the regulatory
              ...
              <p>
                fairbets.co empowers its players by offering several
              ...
              <p>
                <strong>Commitment to Preventing Underage Gambling</strong>
              </p>
              <p>
                A core aspect of fairbets.co’s Responsible Gaming program is the
                prevention of underage gambling. Players must present either a
                valid driver’s license, national ID, passport, or any valid ID
                to register and wager at the fairbets.co sports book website.
              </p>
              <p>
                fairbets.co will verify the player’s identity using a Know Your
                ...
                alert message is sent to fairbets.co’s customer service team who
              ...
              <p>
                <strong>1. </strong>
                <strong>
                  fairbets.co encourages parents and concerned adults to talk to
                  kids early:
                </strong>
              </p>
              <p>
                Begin a meaningful dialogue about the risks of gambling. It’s
                never too early to start the conversation about gambling and its
                risks. By opening a dialogue, concerned adults can help ensure
                that kids are better prepared to make responsible choices now
                and throughout their lives.
              </p>
              <p>
                <strong>2. </strong>
                <strong>
                  fairbets.co advises the players to keep their login
                  information safe:
                </strong>
              </p>
              <p>
                The players must ensure that their account information is
                secure. Parents and other concerned adults should be mindful of
                the possibility that kids can access their accounts and
                passwords or use credit cards and personal information to create
                a fraudulent account.
              </p>
              <p>
                <strong>3. </strong>
                <strong>
                  fairbets.co suggests considering downloading computer
                  safeguards:
                </strong>
              </p>
              <p>
