          ...
          <div className="mb-static-content__content">
            <div className="content">
              ...
              <p className="MsoNormal">
                ...
                to below the "Terms") set out the basis upon which the website
                operated under the URL (the "Website") and its related or
                connected services (collectively, the "Service") will be
                provided to you.
              </p>
              <p className="MsoNormal">
                Please read these Terms very carefully as they form a binding
                legal agreement between you - our customer (the "Customer") -
                and us. By opening an account (the "Account") and using the
                Service you agree to be bound by these Terms, together with any
                amendment which may be published from time to time.
              </p>
              <p className="MsoNormal">
                If anything is not clear to you, please contact us using the
              ...
              <p className="MsoNormal">
                ...
                Communication from fairbets.co will be issued through the
                following:
              </p>
              <p className="MsoNormal">Mail only: info@fairbets.co</p>
              <h1>General Terms</h1>
              <p className="MsoNormal">
              ...
              <p className="MsoNormal" align="left">
                ...
                Department) at info@fairbets.co
              </p>
              <p className="MsoNormal" align="left">
                <span>&nbsp;</span>
                <span>&nbsp;</span>
              </p>
              <h1>1. Your Obligations</h1>
              <p className="MsoNormal" align="left">
                1.1.<span> &nbsp;&nbsp;&nbsp;</span>You agree that at all times
              ...
              <p className="MsoNormal">
                ...
                When sending money to us you are authorized to do so e.g., you
                are the authorized user of the debit/credit card or other
              ...
              <p className="MsoNormal" align="left">
                2.1.<span> &nbsp;&nbsp;&nbsp;</span>You agree that at all times
                when using the Service:
              </p>
              <p className="MsoNormal">
                <span>
              ...
              <p className="MsoNormal">
                ...
                fairbets.co of any changes in your email address.
              </p>
              <p className="MsoNormal">
                <span>
                  2.5.<span>&nbsp;&nbsp;&nbsp;</span>
              ...
              <p className="MsoNormal">
                ...
                fairbets.co shall not be responsible for any damages or losses
                deemed or alleged to have resulted from communications between
                fairbets.co and the Customer using the Registered Email Address.
              </p>
              <p className="MsoNormal">
                <span>
                  2.7.<span>&nbsp;&nbsp;&nbsp;</span>
                ...
                fairbets.co will have his Account suspended until such an
              ...
              <h1>3. Restricted Use</h1>
              <p className="MsoNormal" align="left">
                3.1<span> &nbsp;&nbsp;&nbsp;&nbsp;</span>You must not use the
                Service:
              </p>
              <p className="MsoNormal" align="left">
                <span>
              ...
              <p className="MsoNormal" align="left">
                ...
                other types of unsolicited e-mails or the unauthorized framing
                of, or linking to, the Service). iii) to disrupt or unduly
                affect or influence the activities of other Customers or the
              ...
              <p className="MsoNormal">
                ...
                as an attempt to: (a) cheat the Service or another Customer
                using the Service; or (b) collude with any other Customer using
              ...
              <p className="MsoNormal">
                ...
                you if you use the Service for unauthorized purposes. We may
              ...
              <p className="MsoNormal">
                5.1. We accept Accounts in multiple currencies, please refer to
                All Account balances and transactions appear in the currency
                selected when the Account was originally opened.
              </p>
              <p className="MsoNormal" align="left">
                5.2.<span> &nbsp;&nbsp;&nbsp;</span>We do not give credit for
                the use of the Service.
              </p>
              <p className="MsoNormal">
                5.3. We may close or suspend an Account and refund any monies
                held if you are not or we reasonably believe that you are not
                complying with these Terms, or to ensure the integrity or
                fairness of the Service or if we have other reasonable grounds
                to do so. We may not always be able to give you prior notice.
              </p>
              <p className="MsoNormal">
                5.4. We reserve the right to suspend an Account without prior
                notice and return all funds. Contractual obligations already
                matured will however be honored.
              </p>
              <p className="MsoNormal">
                5.5. We reserve the right to refuse, restrict, cancel, or limit
              ...
              <p className="MsoNormal">
                5.6. If we close or suspend your Account due to you not
                complying with these Terms, we may cancel and/or void any of
                your bets.
              </p>
              <p className="MsoNormal">
                5.7. If any amount is mistakenly credited to your Account it
              ...
              <p className="MsoNormal" align="center">
                5.8.<span> &nbsp;&nbsp;&nbsp;</span>If, for any reason, your
                Account goes overdrawn, you shall be in debt to us for the
                amount overdrawn. You must inform us as soon as you become aware
                of any errors with respect to your Account.
              </p>
              <p className="MsoNormal">
                5.9. Customers have the right to self-exclude themselves from
                fairbets.co Services. These requests have to be received from
                the Customer's Registered Email Address and have to be sent to
                support@fairbets.co<u>.</u>
              </p>
              <p className="MsoNormal">
                5.10. Customers may set limitations on the amount they may wager
                and lose. Such request must be sent from the Customer's
                Registered Email Address to support@fairbets.co.
              </p>
              <p className="MsoNormal">
                5.11. Implementation and increasing of limits shall be processed
                diligently, however, any request for removing or reducing
                limitations shall be done after a cooling-off period of seven
              ...
              <h1>6. Deposit of Funds</h1>
              <p className="MsoNormal">
                6.1 You may deposit funds into your Account by any of the
                methods set out on our Website. All deposits should be made in
                the same currency as your Account and any deposits made in any
                other currency will be converted using the daily exchange rate
                obtained from our own bank's prevailing rate of exchange
                following which your Account will be deposited accordingly.
              </p>
              <p className="MsoNormal">
                6.2 Fees and charges may apply to customer’s deposits and
                withdrawals. Any deposit made to an account which is not{" "}
                <u>rolled over (risked) three times will incur a 3%</u>{" "}
                processing fee and any applicable withdrawal fee. You are
                responsible for your own bank charges that you may incur due to
                depositing funds with us.
              </p>
              <p className="MsoNormal">
                6.3 fairbets.co is not a financial institution and uses a
              ...
              <p className="MsoNormal">
                6.4 Your funds are deposited and held in the respective client
                account based on the currency of your Account. We are not a
                financial institution, and you will not be entitled to any
                interest on any outstanding account balances and any interest
                accrued on the client accounts will be paid to us.
              </p>
              <p className="MsoNormal" align="left">
                6.5<span> &nbsp;&nbsp;&nbsp;&nbsp;</span>Funds originating from
                ill-gotten means must not be deposited with us.
              </p>
              <h1>7. Withdrawal of Funds</h1>
              <p className="MsoNormal">
                7.1 You may withdraw any or all of your Account Balance within
                the transaction maximums as shown on the Website. Note that fees
                may apply.
              </p>
              <p className="MsoNormal" align="left">
                7.2<span> &nbsp;&nbsp;&nbsp; </span>All with
                <s>drawals must be made in the currency of you</s>r Account,
                unless otherwise stipulated by us.
              </p>
              <p className="MsoNormal">
                7.3 We reserve the right to request documentation for the
                purpose of identity verification prior to granting any
                withdrawals from your Account. We also reserve our rights to
                request this documentation at any time during the lifetime of
                your relationship with us.
              </p>
              <p className="MsoNormal">
                7.4 All withdrawals must be made to the original debit, credit
                card, bank account, method of payment used to make the payment
                to your Player’s Account. We may, and always at our own
              ...
              <p className="MsoNormal">
                7.5<span> &nbsp;&nbsp;&nbsp; </span>Should you wish to withdraw
                funds, but your account is either inaccessible, dormant, locked
                or closed, please contact our Customer Service Department at
                support@fairbets.co.
              </p>
              <h1>8. Payment Transactions and Processors</h1>
              <p className="MsoNormal">
                8.1 You are fully responsible for paying all monies owed to us.
                You must make all payments to us in good faith and not attempt
                to reverse a payment made or take any action which will cause
                such payment to be reversed by a third party in order to avoid a
                liability legitimately incurred. You will reimburse us for any
                chargebacks, denial or reversal of payment you make and any loss
                suffered by us as a consequence thereof. We reserve the right to
                also impose an administration fee of €60, or currency equivalent
                per charge-back, denial or reversal of payment you make.
              </p>
              <p className="MsoNormal">
                8.2 We reserve the right to use third party electronic payment
              ...
              <p className="MsoNormal">
                8.3 All transactions made on our site might be checked to
              ...
              <h1>9. Errors</h1>
              <p className="MsoNormal">
                9.1 In the event of an error or malfunction of our system or
              ...
              <p className="MsoNormal">
                9.2 In the event of a casino system malfunction, or
                disconnection issues, all bets are rendered void. In the event
                of such error or any system failure or game error that results
                in an error in any odds calculation, charges, fees, rake,
                bonuses or payout, or any currency conversion as applicable, or
                other casino system malfunction (the "Casino Error"), we reserve
                the right to declare null and void any wagers or bets that were
                the subject of such Casino Error and to take any money from your
                Account relating to the relevant bets or wagers.
              </p>
              <p className="MsoNormal">
                9.3 We make every effort to ensure that we do not make errors in
              ...
              <p className="MsoNormal" align="left">
                9.4<span> &nbsp;&nbsp;&nbsp; </span>We have the right to recover
              ...
              <h1>10. &nbsp;&nbsp;&nbsp;General Rules</h1>
              <p className="MsoNormal" align="left">
                10.1<span> &nbsp;&nbsp;&nbsp; </span>If a sport-specific rule
                contradicts a general rule, then the general rule will not
                apply.
              </p>
              <p className="MsoNormal">
                10.2 The winner of an event will be determined on the date of
                the event's settlement; we do not recognize protested or
              ...
              <p className="MsoNormal">
                10.3 All results posted shall be final after 72 hours and no
                queries will be entertained after that period of time. Within 72
                hours after results are posted, the company will only
                reset/correct the results due to human error, system error or
                mistakes made by the referring results source.
              </p>
              <p className="MsoNormal">
                10.4 Minimum and maximum wager amounts on all sporting events
                will be determined by us and are subject to change without prior
                written notice. We also reserve the right to adjust limits on
                individual Accounts as well.
              </p>
              <p className="MsoNormal">
                10.5 Customers are solely responsible for their own Account
              ...
              <p className="MsoNormal">
                10.6 For a wager to have action on any named contestant in a
                Yes/No Proposition, the contestant must enter and compete in the
                event.
              </p>
              <p className="MsoNormal">
                10.7 A game/match will have action regardless of the League
                heading that is associated with the matchup. For example, two
                teams from the same League are playing in a Cup competition. If
                the matchup is mistakenly placed in the League offering, the
                game/match will still have action, as long as the matchup is
                correct. In other words, a matchup will have action as long as
                the two teams are correct, and regardless of the League header
                in which it is placed on our Website.
              </p>
              <p className="MsoNormal">
                10.8 If an event is not played on the same date as announced by
                the governing body, then all wagers on the event have no action.
              ...
              <p className="MsoNormal">
                10.9 fairbets.co reserves the right to remove events, markets
                and any other product from the website. fairbets.co reserves the
                right to restrict the casino access of any player without prior
                notice.
              </p>
              <p className="MsoNormal">
                10.10 In all futures wagering (for example, total season wins,
                Super Bowl winner, etc.), the winner as determined by the
                Governing Body will also be declared the winner for betting
                purposes except when the minimum number of games required for
                the future to have "action" has not been completed.
              </p>
              <h1>11. &nbsp;&nbsp;&nbsp;Communications and Notices</h1>
              <p className="MsoNormal">
                11.1<span> &nbsp;&nbsp;&nbsp; </span>All communications&nbsp;
                and notices&nbsp; to be given under&nbsp; these Terms by you to
                us shall be sent&nbsp; to support@fairbets.co.
              </p>
              <p className="MsoNormal">
                11.2 All communications and notices to be given under these
              ...
              <p className="MsoNormal">
                11.3 All communications and notices to be given under these
                Terms by either you or us shall be in writing in the English
                language. When the service is not operated by fairbets.co all
                communications must be given to and from the Registered Email
                Address in your Account.
              </p>
              <h1>12. &nbsp;&nbsp;&nbsp;Matters Beyond Our Control</h1>
              <p className="MsoNormal">
                12.1 We cannot be held liable for any failure or delay in
                providing the Service due to an event of Force Majeure which
                could reasonably be considered to be outside our control despite
                our execution of reasonable preventative measures such as: an
                act of God; pandemic diseases; trade or labor dispute; power
                cut; act, failure or omission of any government or authority;
                obstruction or failure of telecommunication services; or any
                other delay or failure caused by a third party, and we will not
                be liable for any resulting loss or damage that you may suffer.
                In such an event, we reserve the right to cancel or suspend the
                Service without incurring any liability.
              </p>
              <h1>13. &nbsp;&nbsp;&nbsp;&nbsp;Liability</h1>
              <p className="MsoNormal">
                13.1 To the extent permitted by applicable law, we will not
              ...
              <p className="MsoNormal">
                13.2<span> &nbsp;&nbsp;&nbsp; </span>In the event that we are
                held liable for any event under these terms, our total aggregate
                liability to you under or in connection with these terms shall
                not exceed:
              </p>
              <p className="MsoNormal">
                i) The value of the bets and or wagers you placed via your
              ...
              <p className="MsoNormal" align="left">
                13.3<span> &nbsp;&nbsp;&nbsp; </span>We strongly recommend that
                you:
              </p>
              <p className="MsoNormal">
                <span>
                ...
                take care to verify the suitability and compatibility of the
              ...
              <p className="MsoNormal">
                ...
                take reasonable precautions to protect yourself against harmful
                programs or devices including through installation of anti-virus
                software.
              </p>
              <h1>14. &nbsp;&nbsp;&nbsp;Gambling by Those Underage</h1>
              <p className="MsoNormal">
                14.1 If we suspect that you are or receive notification that you
                are currently under 18 years or were under 18 years (or below
                the age of majority as stipulated in the laws of the
                jurisdiction applicable to you) when you placed any bets through
                the Service your Account will be suspended to prevent you
                placing any further bets or making any withdrawals from your
              ...
              <p className="MsoNormal" align="left">
                14.2<span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>If having found
                that you:
              </p>
              <p className="MsoNormal">
                <span>
              ...
              <p className="MsoNormal">
                ...
                any monies deposited in your fairbets.co Account which are not
              ...
              <h1>15. &nbsp;&nbsp;&nbsp;&nbsp;Fraud</h1>
              <p className="MsoNormal">
                15.1&nbsp;&nbsp;&nbsp; We will seek criminal and contractual
                sanctions against any Customer involved in fraud, dishonesty, or
                criminal acts. We will withhold payment to any Customer where
                any of these are suspected. The Customer shall indemnify and
                shall be liable to pay to us on demand, all costs, charges, or
                losses sustained or incurred by us (including any direct,
                indirect or consequential losses, loss of profit, loss of
                business and loss of reputation) arising directly or indirectly
                from the Customer’s fraud, dishonesty or criminal act.
              </p>
              <h1>16. &nbsp;&nbsp;&nbsp;Intellectual Property</h1>
              <p className="MsoNormal">
                16.1 We trade as fairbets.co and the fairbets.co name and logo
                are registered trademarks. Any unauthorized use of our trademark
                and logo may result in legal action being taken against you.
              </p>
              <p className="MsoNormal">
                16.2 The uniform resource locator (URL) is owned by us and no
                unauthorized use of the URL is permitted on another website or
                digital platform without our prior written consent.
              </p>
              <p className="MsoNormal">
                16.3 As between us and you, we are the sole owners of the rights
                in and to the Service, our technology, software, and business
                systems (the "Systems") as well as our odds.
              </p>
              <p className="MsoNormal">
                <span>
                  i)<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
              ...
              <p className="MsoNormal" align="left">
                ...
                dress, logos (the "Marks") and/or our odds in connection with
              ...
              <h1>17. &nbsp;&nbsp;&nbsp;&nbsp;Your Licence</h1>
              <p className="MsoNormal">
                17.1 Subject to these Terms and your compliance with them, we
                grant to you a non-exclusive, limited, nontransferable and
                non-sub-licensable license to access and use the Service for
                your personal non- commercial purposes only. Our license to you
                terminates if our agreement with you under these Terms ends.
              </p>
              <p className="MsoNormal">
                17.2 Save in respect of your own content, you may not under any
              ...
              <p className="MsoNormal">
                17.3 Any non-compliance by you with this Clause may also be a
              ...
              <h1>18. &nbsp;&nbsp;&nbsp;Your Conduct and Safety</h1>
              <p className="MsoNormal">
                18.1 We would like you to enjoy the Service. However, for your
                protection and that of all Customers, the posting of any content
                on the Service, as well as conduct in connection therewith
                and/or the Service, which is in any way unlawful, inappropriate,
                or undesirable is strictly prohibited - it is Prohibited
                Behavior. If you engage in Prohibited Behavior, or we determine
                in our sole discretion that you are engaging in Prohibited
                Behavior, your Player’s Account and/or your access to or use of
                the Service may be terminated immediately without notice to you.
              </p>
              <p className="MsoNormal">
                18.2 Legal action may be taken against you by another Customer,
                other third party, enforcement authorities and/or us with
                respect to you having engaged in Prohibited Behavior.
              </p>
              <p className="MsoNormal" align="left">
                18.3<span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Prohibited
                Behavior includes, but is not limited to, accessing, or using
                the Service to:
              </p>
              <p className="MsoNormal">
                <span>
              ...
              <h1>19. &nbsp;&nbsp;&nbsp;Links to Other Websites</h1>
              <p className="MsoNormal">
                19.1 The Service may contain links to third party websites that
                are not maintained by, or related to, us, and over which we have
                no control.
              </p>
              <p className="MsoNormal">
              ...
              <h1>20. &nbsp;&nbsp;&nbsp;&nbsp;Complaints</h1>
              <p className="MsoNormal">
                20.1 If you have any concerns or questions regarding these Terms
                you should contact our Customer Service Department via email at
                support@fairbets.co.
              </p>
              <p className="MsoNormal">
                20.2 NOTWITHSTANDING THE FOREGOING, WE TAKE NO LIABILITY
                WHATSOEVER TO YOU OR TO ANY THIRD PARTY WHEN RESPONDING TO ANY
                COMPLAINT THAT WE RECEIVED OR TOOK ACTION IN CONNECTION
                THEREWITH.
              </p>
              <p className="MsoNormal">
                20.3 Any Customer of the Service who has any concerns or
                questions regarding these Terms regarding the settlement of any
                bonanza.pe market should contact our Customer Service Department
                at support@fairbets.co using their Registered Email Address.
              </p>
              <p className="MsoNormal">
                20.4 If a Customer is not satisfied with how a bet has been
                settled, then the Customer should provide details of their
                grievance to our Customer Service Department via email at
                support@fairbets.co. We shall use our reasonable endeavors to
                respond to queries of this nature within a few days (and in any
                event we intend to respond to all such queries within 28 days of
                receipt).
              </p>
              <p className="MsoNormal">
                20.5 Disputes must be lodged within three (3) days from the date
                the wager in question has been decided. No claims will be
                honored after this period. The Customer is solely responsible
                for their Account transactions. Complaints/disputes have to be
                sent to support@fairbets.co and must be sent from the Customer's
                Registered Email Address.
              </p>
              <p className="MsoNormal">
                20.6 In the event of a dispute arising between you and us our
                ...
                to our management in accordance with our Complaints Procedure
              ...
              <p className="MsoNormal">
                20.8 Customers being provided with the service from fairbets.co
                should, contact Curaçao Internet Gaming Association and/or the
                Department of Judicial Affairs of Curaçao.
              </p>
              <h1>21. &nbsp;&nbsp;&nbsp; Registration and Account Security</h1>
              <p className="MsoNormal">
                21.1 Customers of the Service must provide their real names and
                information and, in order to comply with this, all Customers
                must commit to the following rules when registering &amp;
              ...
              <p className="MsoNormal">
                23.1 In the event that any provision of these Terms is deemed by
                any competent authority to be unenforceable or invalid, the
                relevant provision shall be modified to allow it to be enforced
                in line with the intention of the original text to the fullest
                extent permitted by applicable law. The validity and
                enforceability of the remaining provisions of these Terms shall
                not be affected.
              </p>
              <h1>24. &nbsp;&nbsp;&nbsp;Breach of These Terms</h1>
              <p className="MsoNormal">
                24.1&nbsp;&nbsp;&nbsp; Without limiting our other remedies, we
                may suspend or terminate your Account and refuse to continue to
                provide you with the Service, in either case without giving you
                prior notice, if, in our reasonable opinion, you breach any
                material term of these Terms. Notice of any such action taken
              ...
              <p className="MsoNormal">
                ...
                access or use the Service or are a Customer of fairbets.co.
                These Terms will survive the termination of your Player’s
              ...
              <p className="MsoNormal">
                27.1 fairbets.co is operated by Three Aces Curaçao N.V., a
              ...
              <p className="MsoNormal">
                ...
                to: support@fairbets.co. Complete casino rules can be accessed
              ...
              <p className="MsoNormal">
                ...
                This is my first/only registration fairbets.co
              </p>
              <p className="MsoNormal">
                <span>
                  29.2.4<span>&nbsp;&nbsp;&nbsp; </span>
              ...
              <p className="MsoNormal">
                ...
                I declare that all information provided by me to fairbets.co is
              ...
              <p className="MsoNormal">fairbets.co</p>
              <p className="MsoNormal">
                <span>
                  29.2.7<span>&nbsp;&nbsp;&nbsp; </span>
                </span>
                I am aware and acknowledge that fairbets.co sets certain
