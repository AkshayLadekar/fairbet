    ...
    <div>
      ...
      <div className="mb-static-content">
        <div className="mb-static-content__rightside">
          <h1>KYC and Privacy Policy for fairbets.co</h1>
          <div className="mb-static-content__content">
            <div className="content">
              <p>
                At fairbets.co, one of our main priorities is the privacy of our
                clients. This Privacy Policy document contains types of
                information that are collected and processed by fairbets.co and
                how we use it.
              </p>
              <p>
                If you have additional questions or require more information
                about our Privacy Policy, kindly contact us by email at
                support@fairbets.co.com.
              </p>
              <p>
                This Privacy Policy applies to our data processing activities
                and is valid for all our clients with regards to the information
                that they shared with fairbets.co. This policy is applicable to
                any information collected both online and offline.
              </p>
              <h2>
              ...
              <p>
                If you contact fairbets.co directly, we may receive additional
              ...
              <p>
                Like any other website, fairbets.co website use 'cookies'. These
              ...
              <p>
                fairbets.co's Privacy Policy does not apply to other advertisers
              ...
              <p>
                Another part of fairbets.co priority is adding protection for
              ...
              <p>
                fairbets.co does not knowingly collect any Personal Identifiable
