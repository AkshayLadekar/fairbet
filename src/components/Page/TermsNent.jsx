            ...
            <div className="content">
              <ol>
                <li>
                  ...
                  <strong>
                    <span className="markedContent">
                      <span>NetEnt will not permit</span> <span>NetEnt</span>{" "}
                      <span>Casino</span> <span>Games</span>{" "}
                      <span>to be supplied to any entity that operates in</span>{" "}
                      <span>
                        any of the below jurisdictions (irrespective of whether
                        or not NetEnt Casino Games are
                      </span>{" "}
                  ...
                  <span className="markedContent">
                    <span>
                      Belgium, Bulgaria, Colombia, Croatia, Czech Republic,
                      Denmark, Estonia, France, Italy, Latvia,
                    </span>{" "}
                    <span>
                ...
                <li>
                  ...
                  <strong>
                    <span className="markedContent">
                      <span>
                        All NetEnt Casino Games may not be offered in the
                  ...
                  <span className="markedContent">
                    ...
                    <span>Guyana,</span> <span>Hong</span> <span>Kong,</span>{" "}
                    <span>Italy,</span> <span>Iran,</span> <span>Iraq,</span>{" "}
                    <span>Israel,</span> <span>Kuwait,</span>{" "}
                    <span>Latvia,</span> <span>Lithuania,</span>{" "}
                    <span>Mexico,</span> <span>Namibia,</span>{" "}
                    <span>
                      Nicaragua, North Korea, Pakistan, Panama, Philippines,
                    </span>{" "}
                    <span>Portugal,</span>{" "}
                    <span>Romania, Singapore, Spain,</span>{" "}
                    <span>Sweden, Switzerland, Sudan, Syria, Taiw</span>
                    <span>an, Trinidad and Tobago, Tunisia, Uganda,</span>{" "}
                    <span>United</span>{" "}
                ...
                <li>
                  ...
                  <strong>
                    <span className="markedContent">
                      <span>
                        The followed NetEnt Braded Games have some further
                  ...
                  <ol>
                    <li>
                      <strong>
                        <span className="markedContent">
                          <span>In</span> <span>addition</span> <span>to</span>{" "}
                          <span>the</span> <span>jurisdictions</span>{" "}
                          <span>set</span> <span>out</span> <span>in</span>{" "}
                          <span>paragraph</span> <span>2, Planet</span>{" "}
                          <span>of</span> <span>the</span> <span>Apes</span>{" "}
                      ...
                      <span className="markedContent">
                        <span>
                          Azerbaijan, China, India, Malaysia, Qatar, Russia,
                    ...
                    <li>
                      <strong>
                        <span className="markedContent">
                          <span>In</span>{" "}
                          <span>
                            addition to the jurisdictions set out in paragraph
                            2, Vikings Video Slot must not be{" "}
                          </span>
                      ...
                      <span className="markedContent">
                        <span>
                          Azerbaijan, Cambodia, Canada, China, France, India,
                          Indonesia, Laos, Malaysia, Myanmar,
                        </span>{" "}
                        <span>Papua New Guinea, Qatar, Russia, South Kore</span>
                        <span>
                          a, Thailand, Turkey, Ukraine, United States of
                        </span>{" "}
                        <span>America.</span>
                      </span>
                    </li>
                    <li>
                      <strong>
                        <span className="markedContent">
                          <span>
                            In addition to the jurisdictions set out in
                            paragraph 2, Narcos Video Slot must not be{" "}
                          </span>
                          <span>offered in the following territories:</span>
                        </span>
                      </strong>
                      <span className="markedContent">
                    ...
                    <li>
                      <strong>
                        <span className="markedContent">
                          <span>
                            In addition to the jurisdictions set out in paragr
                          </span>
                          <span>aph 2, Street Fighter Video Slot</span>{" "}
                          <span>must not </span>
                          <span>be offered in the following</span>{" "}
                      ...
                      <span className="markedContent">
                        <span>
                          ...
                          Barbados, Bahamas, Belize, Bermuda, Bolivia,
                        </span>{" "}
                        <span>
                          Bonaire, Brazil, British Virgin Islands, Canada,
                          Cayman Islands, China,
                        </span>{" "}
                        <span>Chile, Clipperton Island,</span>{" "}
                        <span>
                          Columbia, Costa Rica, Cuba, Curacao, Dominica,
                        ...
                        <span>Pu</span>
                        <span>erto</span> <span>Rico,</span> <span>Saba,</span>{" "}
                        <span>Saint</span> <span>Barthelemy,</span>{" "}
                        <span>Saint</span> <span>Eustatius,</span>{" "}
                        <span>Saint</span> <span>Kitts</span> <span>and</span>{" "}
                        ...
                        <span>Vincent</span> <span>and</span> <span>the </span>
                        <span>Grenadines,</span> <span>South Korea,</span>{" "}
                        <span>Suriname,</span> <span>Turks</span>{" "}
                        <span>and</span> <span>Caicos</span>{" "}
                        <span>Islands,</span> <span>United</span>{" "}
                        <span>States of</span>{" "}
                        <span>America, Uruguay, US Virgin Islands,</span>{" "}
                        <span>Venezuela</span>
                      </span>
                      .
                    </li>
                    <li>
                      <strong>
                        <span className="markedContent">
                          <span>
                            In addition to the jurisdictions set out in
                            paragraph 2, Fashion TV Video Slot must not be{" "}
                          </span>
                          <span>offered in the following</span>{" "}
                          <span>territories:</span>
                        </span>
                ...
                <li>
                  <strong>
                    <span className="markedContent">
                      ...
                      <span>
                        Invisible Man) may only be played in the following
                        territories:
                      </span>
                    </span>
                  </strong>
                  <span className="markedContent">
                    ...
                    <span>Belarus,</span> <span>Bosnia</span> <span>and</span>{" "}
                    <span>Herzegovina,</span> <span>Cyprus,</span>{" "}
                    <span>Finland,</span> <span>Georgia,</span>{" "}
                    <span>Germany, Greece,</span> <span>Hungary,</span>{" "}
                    <span>Iceland,</span> <span>Ireland,</span>{" "}
                    <span>Liechtenstein,</span> <span>Luxembourg, Malta,</span>{" "}
                    <span>Moldova,</span> <span>Monaco,&nbsp; Montenegro,</span>{" "}
